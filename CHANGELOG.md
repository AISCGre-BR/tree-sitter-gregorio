...
### Fixed
- Missing comma after the `"version"` field in `tree-sitter.json` (malformed JSON).
- Incorrect author email in `tree-sitter.json` metadata
  (`laercio@sivali.sousa.nom.br` → `laercio.sousa@aiscgre.org.br`).

## [0.5.1] - 2026-05-04

### Fixed
- Missing comma after the `"version"` field in `package.json` (malformed JSON).
...
[0.5.2]: https://github.com/AISCGre-BR/tree-sitter-gregorio/releases/tag/v0.5.2
[0.5.1]: https://github.com/AISCGre-BR/tree-sitter-gregorio/releases/tag/v0.5.1
[0.5.0]: https://github.com/AISCGre-BR/tree-sitter-gregorio/releases/tag/v0.5.0
[0.4.0]: https://github.com/AISCGre-BR/tree-sitter-gregorio/releases/tag/v0.4.0
